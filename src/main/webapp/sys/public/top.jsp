...
<script language="javascript" type="text/javascript">
    function logout(){
            ...
            top.location = "${pageContext.request.contextPath }/sys_login/index.jsp";
	...
	<div id="Head_1">
		...
		<div id="Head_1_UserWelcome">
			<img border="0" width="13" height="14"
				src="${pageContext.request.contextPath }/sys/style/images/user.gif" />
			您好，<b><%=username %></b>
		</div>
		<!-- 一些链接按钮 -->
		<div id="Head_1_FunctionButton">
			<a target="right" > <img width="78"
				height="20"
				src="${pageContext.request.contextPath }/sys/style/images/help2.gif" />
				
			</a> <a target="_parent" href="javascript:logout();"> <img width="78"
				height="20" alt="退出系统"
	...
	<div id="Head_2">
		...
		<div class="Head2_FunctionList" style="float: left">
			<a href="javascript: window.parent.right.history.back();"> <img
				src="${pageContext.request.contextPath }/sys/style/images/Header_back.gif"
				width="24" height="24" style="margin-top: -8px;" /> <b>后退</b>
			</a> <a href="javascript: window.parent.right.history.forward();"> <img
				src="${pageContext.request.contextPath }/sys/style/images/Header_forward.gif"
		...
		<div id="Head2_FunctionList">
			...
			<a href="javascript: window.parent.right.history.go(0);"> <img
				src="${pageContext.request.contextPath }/sys/style/images/Header_refresh.gif"
