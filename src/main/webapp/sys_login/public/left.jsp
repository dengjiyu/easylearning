	    ...
	    <li class="level1">
            ...
            <ul class="MenuLevel2">
            	<li class="level2 level2Style">
                    <a target="right" href="<%=path%>/data_add.jsp">资料添加</a>
				</li>
                <li class="level2 level2Style">
                	<a target="right" href="<%=path%>/data_show.jsp">资料详情</a>
				</li>
                <li class="level2 level2Style">
                	<a target="right" href="${pageContext.request.contextPath }/food?method=list">分区二</a>
				</li>
                <li class="level2 level2Style">
                	<a target="right" href="${pageContext.request.contextPath }/order?method=getOrderList">分区三</a>
				</li>
            </ul>
        </li>
    </ul>
